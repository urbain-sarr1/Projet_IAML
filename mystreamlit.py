...
sections = ['Aperçu des données', 'Nettoyage des données', 'Visualisation des données', 
            'Entraînement du modèle', 'Évaluation du modèle', 'Importance des variables', 
            'Amélioration du modèle', 'Explication des prédictions']
selection = st.sidebar.radio("Aller à :", sections)

st.title("🔍 Dashboard Analyse de la résiliation client")

# 1. Chargement des données
if selection == 'Aperçu des données':
...
if selection == 'Nettoyage des données':
...
if selection == 'Entraînement du modèle':
...
if selection == 'Évaluation du modèle':
...
if selection == 'Importance des variables':
...
if selection == 'Amélioration du modèle':
...
# 8. Explication des prédictions
if selection == 'Explication des prédictions':
